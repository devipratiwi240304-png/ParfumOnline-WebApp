<%-- Document : index Created on : 26 Des 2025, 20.47.20 Author : Devi Pratiwi --%>
    ...
    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <body>
            <div class="container">
                ...
                <div>
                    <a href="${pageContext.request.contextPath}/auth/login" class="btn">
